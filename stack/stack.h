...
{ 
 ...
 public: // prototypes to be used by the client
  ...
  //          otherwise, throws an exception - Underflow
  // PARAMETER: provide variable to return the top element
  void topElem(el_t&);
  
  // ** Must add good comments for each function - See Notes1B

  //PURPOSE: Checks to see if the array is empty; if empty return true else return false
  bool isEmpty();

  //PURPOSE: Checks to see if the the array is full, if full return true else return false
  bool isFull();

  //PURPOSE: To display all the elements in the stack
  void displayAll();

  //PURPOSE: To remove all the elements in the stack
  void clearIt();
};
